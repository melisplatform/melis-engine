                        ...
                        'pids_page_id_start' => array(
                            ...
                            'validators' => array(
                                array(
                                    ...
                                    'options' => array(
                                        'message' => array(
                                            \Zend\I18n\Validator\IsInt::INVALID => 'pids_page_id_start must be an Integer'
                                        ),
                                    ),
                                ),
                            ),
                        ...
                        'pids_page_id_current' => array(
                            ...
                            'validators' => array(
                                array(
                                    ...
                                    'options' => array(
                                        'message' => array(
                                            \Zend\I18n\Validator\IsInt::INVALID => 'pids_page_id_current must be an Integer'
                                        ),
                                    ),
                                ),
                            ),
                        ...
                        'pids_page_id_end' => array(
                            ...
                            'validators' => array(
                                array(
                                    ...
                                    'options' => array(
                                        'message' => array(
                                            \Zend\I18n\Validator\IsInt::INVALID => 'pids_page_id_end must be an Integer'
                                        ),
                                    ),
                                ),
                            ),
                        ...
                        'pids_tpl_id_end' => array(
                            ...
                            'validators' => array(
                                array(
                                    ...
                                    'options' => array(
                                        'message' => array(
                                            \Zend\I18n\Validator\IsInt::INVALID => 'pids_tpl_id_end must be an Integer'
                                        ),
                                    ),
                                ),
                            ),
